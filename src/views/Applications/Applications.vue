...
import InvitesView from "@/components/ui/Applications/InvitesView.vue";
import Applications from "@/components/ui/Applications/Applications.vue";
import JobOffers from "@/components/ui/Applications/Offers.vue";
import MyJobs from "@/components/ui/Applications/MyJobs.vue";
import Invoices from "@/components/ui/Applications/Invoices.vue";
  ...
  <DashboardLayout
    ><div class="container mb-20">
      <Tab>
        ...
        <template #view2>
            <!-- <Applications class="hidden"/> -->
            <ComingSoon title="Applications" />
        </template>
        <template #view3
