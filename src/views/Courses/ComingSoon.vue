  ...
  <DashboardLayout>
    <div class="container p-0 lg:p-6 lg:py-3 py-4 mb-5">
      ...
      <p class="text-[#244034] text-[17.633px] mt-10 leading-[27.356px] font-normal">
        We are still building your talent dashboard, and we are yet to launch our courses.
        <br />
        Is there anything you were looking for? please send us an email to
      ...
      <div class="bg-[#84B358] p-14 rounded-[7.973px] mt-12">
        <p class="text-[#FBFBEE] text-[47.239px] mt-6 leading-[56.484px] font-medium">
          Join our email community
        </p>
        <p class="text-[#FBFBEE] text-[21.714px] mt-4 leading-[25.964px] font-medium">
