<template>
    <article class="flex flex-col h-full">
         <div class="rounded-t-[1.13825rem]">
             <img :src="props.event?.featured_graphics" alt="" class="w-full h-full object-cover rounded-t-[1rem]">
         </div>
         <div class="flex-grow px-[1.24rem] pb-[2rem] pt-4 bg-[#ECFAFC] rounded-b-[1.32038rem] flex flex-col justify-between">
             <h1 class="text-[#000] leading-[1.2rem] font-SegeoUI font-[600] mb-[0.98rem] tab:text-[0.865rem]">{{ props.event?.title }}</h1>
