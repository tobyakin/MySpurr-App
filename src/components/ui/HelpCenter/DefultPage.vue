...
<template>
  <div class="w-full flex flex-col lg:gap-[81.97px] gap-[41.97px]">
    ...
    >
      <div
        class="w-full mt-2 font-light font-normal p-4 py-1.5 border-[#000000AB] border-[0.737px] opacity-[0.8029] !bg-[#31795A00] rounded-[5.897px] text-[12.68px]"
      >
        <GlobalInput
    ...
    <div class="flex flex-col justify-evenly lg:gap-[60.313px] gap-[30.313px]">
      ...
      >
        ...
        >
          ...
          <p class="text-[#011B1F] text-[10.297px] font-normal lg:leading-[12.408px]">
